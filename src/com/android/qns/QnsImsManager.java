 ...
 * @hide
 */
public class QnsImsManager {

    public static final String PROP_DBG_WFC_AVAIL_OVERRIDE = "persist.dbg.wfc_avail_ovr";
     ...
     */
    public static QnsImsManager getInstance(Context context, int slotId) {
     ...
     */
    public int getImsServiceState() throws ImsException, InterruptedException {
