...
public class Threshold {
    private static final AtomicInteger mTid = new AtomicInteger();
    ...
    public Threshold(
        ...
        this.mThresholdId = mTid.getAndIncrement();
    ...
    public void setAccessNetwork(int accessNetwork) {
        this.mAccessNetwork = accessNetwork;
    }
    ...
    public boolean isMatching(int threshold) {
    ...
    public boolean identicalThreshold(Threshold o) {
