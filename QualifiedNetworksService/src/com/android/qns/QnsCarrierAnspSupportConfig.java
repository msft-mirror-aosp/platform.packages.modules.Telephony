...
class QnsCarrierAnspSupportConfig {
     ...
     * a default value set will apply.
     */
    static final String KEY_VOICE_EUTRAN_RSSNR_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VIDEO_EUTRAN_RSSNR_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VOICE_NGRAN_SSRSRP_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VIDEO_NGRAN_SSRSRP_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VOICE_NGRAN_SSRSRQ_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VIDEO_NGRAN_SSRSRQ_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VOICE_NGRAN_SSSINR_INT_ARRAY =
     ...
     * a default value set will apply.
     */
    static final String KEY_VIDEO_NGRAN_SSSINR_INT_ARRAY =
     ...
     */
    static QnsCarrierAnspSupportConfig getInstance(Context context, int slotIndex) {
