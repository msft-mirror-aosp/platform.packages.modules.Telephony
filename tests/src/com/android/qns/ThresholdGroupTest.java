...
public class ThresholdGroupTest {
    ...
    @Mock QualityMonitor mockWifiQualityMonitor;
    @Mock QualityMonitor mockCellularQualityMonitor;
    ...
    public void setUp() {
        ...
        mThresholdList.add(
                new Threshold(
                        ...
                        QnsConstants.DEFAULT_WIFI_BACKHAUL_TIMER));
        doReturn(-120, -116)
                .when(mockCellularQualityMonitor)
                .getCurrentQuality(
                        AccessNetworkConstants.AccessNetworkType.EUTRAN,
                        SignalThresholdInfo.SIGNAL_MEASUREMENT_TYPE_RSRP);
        doReturn(-16, -13)
    ...
    public void testFindUnmatchedThresholds() {
        ...
        List<Threshold> output =
                mThresholdGroup.findUnmatchedThresholds(
                        mockWifiQualityMonitor, mockCellularQualityMonitor);
